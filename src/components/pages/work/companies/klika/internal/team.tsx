...
const data: TTeamList[] = [
  { id: 1, title: "Product Owners", min: 1 },
  { id: 2, title: "Project Managers", min: 1 },
  { id: 3, title: "Quality Assurance Engineers", min: 1 },
  { id: 4, title: "Fullstack Developers", min: 1, max: 4 },
];
