...
const data: TTeamList[] = [
  { id: 1, title: "Product Owners", min: 1, max: 2 },
  { id: 2, title: "Project Managers", min: 1, max: 2 },
  { id: 3, title: "Business Analysts", min: 1 },
  { id: 4, title: "Quality Assurance Engineers", min: 1, max: 3 },
  { id: 5, title: "Frontend Developers", min: 1, max: 2 },
  { id: 6, title: "Backend Developers", min: 5, max: 7 },
];
